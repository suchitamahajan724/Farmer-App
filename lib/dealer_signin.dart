...
class DealerSignin extends StatefulWidget {
  @override
  _DealerSigninState createState() => _DealerSigninState();
}

class _DealerSigninState extends State<DealerSignin> {
  Future<DealerData> futureFarmerData;
  @override
  /* void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: AppBar(
          title: new Text("Dealer's Signin"),
        ),
